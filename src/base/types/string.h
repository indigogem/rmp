...
namespace kmp {
    ...
    namespace StringUtils {
        ...
        inline bool EndsWith(StringType const& inStr, char const* pStringToMatch) {
            KMP_ASSERT(pStringToMatch != nullptr);
            size_t const matchStrLen = strlen(pStringToMatch);
            KMP_ASSERT(matchStrLen > 0);
        ...
        inline StringType ReplaceAllOccurrences(StringType const& originalString, char const* pSearchString, char const* pReplacement) {
            KMP_ASSERT(pSearchString != nullptr);
        ...
        KMP_BASE_API int32_t CompareInsensitive(char const* pStr0, char const* pStr1);
        KMP_BASE_API int32_t CompareInsensitive(char const* pStr0, char const* pStr1, size_t n);
